...
public class GameView extends JFrame {
    ...
    public void endGame(int winner) {
        switch (winner) {
            case 0:
                String message = "Bạn đã thua!";
                JOptionPane.showMessageDialog(null, message, "Trò chơi kết thúc", JOptionPane.INFORMATION_MESSAGE);
                System.exit(0);
                break;
            case 1:
                String message1 = "Chúc mừng bạn đã thắng!";
                JOptionPane.showMessageDialog(null, message1, "Trò chơi kết thúc", JOptionPane.INFORMATION_MESSAGE);
                System.exit(0);
                break;
            case 2:
                String message2 = "Trò chơi kết thúc, hòa nhau!";
                JOptionPane.showMessageDialog(null, message2, "Trò chơi kết thúc", JOptionPane.INFORMATION_MESSAGE);
                System.exit(0);
                break;
            default:
                break;
